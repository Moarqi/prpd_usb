...
SCHEMA = [
    ...
    Command("solar", "5a00710200001db6a5", [
        Field('I', "?_W_total_phase_1", "Wh", 1),
        Field('I', "?_W_total_phase_2", "Wh", 1),
        Field('I', "?_W_total_phase_3", "Wh", 1),
    ]),
    Command("solar", "5a0071000000dd17a5", [
        Field('I', "?_W_toal_backup", "Wh", 1),
        Field('I', "?_W_total", "Wh", 1),
        Field('I', "?_W", "Wh", 1),
    ]),   
    ...
    Command("solar", "5a0070020000e1b7a5", [
        ...
        Field('H', '?_P_string_2', "W", 0.1),
    ]),
    Command("battery", "5a0070010000e147a5", [
        Field('H', 'U', "V", 0.01),
        Field('i', 'I', "A", 0.01),
        Field('I', 'TBD', 'TBD', 0.01),
        Field('H', 'TBD', 'TBD', 0.01),
        Field('h', 'P', "W", 1),
        Field('B', 'SoC', "%", 1),
        Field('h', 'temp1', "°C", 0.1),
        Field('h', 'temp2', "°C", 0.1),
